...
import { ArrowLeft, Clock, Calendar, Share2, CheckCircle2, DollarSign, TrendingUp, Home, PiggyBank, Calculator, Percent, ArrowDownCircle, ArrowUpCircle, Linkedin } from 'lucide-react';
